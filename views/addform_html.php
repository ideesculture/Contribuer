        ...
        "form": {
            ...
            "buttons": {
                "prepare": {
                    "title":"SEND",
                    "click": function() {
	                    $("#alpaca_serialization").remove();
	                    $("#form1 > form > .alpaca-top").append("<textarea name='alpaca_serialization' style='display:none;' id='alpaca_serialization'></textarea");
	                    $("#alpaca_serialization").html(JSON.stringify(this.getValue(), null, "  "));
	                    $("#form1 > form").submit();
                    }
