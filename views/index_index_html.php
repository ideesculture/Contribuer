...
<div class="container contribute">
	...
	<div class="row" style="padding-top:40px;">
		<div class="col-md-6">
			...
			<p><a href="<?php print __CA_URL_ROOT__; ?>/index.php/Contribuer/Do/Form/table/ca_objects/type/article">Create a new article</a></p>
	...
	<div class="row" style="padding-top:40px;">
		<div class="col-md-6">
			...
			<p><a href="<?php print __CA_URL_ROOT__; ?>/index.php/Contribuer/Do/Form/table/ca_entities/type/individual">Create a new individual</a></p>
			<p><a href="<?php print __CA_URL_ROOT__; ?>/index.php/Contribuer/Do/Form/table/ca_entities/type/organization">Create a new organization</a></p>
			<p>&nbsp;</p>
			<div style="border-bottom:1px solid #ddd;width:70%;margin:auto;">&nbsp;</div>
		</div>
		<div class="col-md-6">
