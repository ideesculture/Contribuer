...
?>	
		<p>Upload a new image to replace the existing cover.</p>
		<iframe style="margin:0;padding:0;height:60px;width:700px;border:none;overflow: hidden;" src="/upload/manual.php?id=<?php print $id; ?>"></iframe>
