...
<div class="container">
	<div class="row" style="padding-top:120px;">	
        <h1>Contribute to the database <small>add a magazine issue</small></h1>
...
foreach($properties as $name=>$property) {
    if(is_string($property) && ($name != "mapping") && ($name != "placeholder") && ($name != "dataSource")) print "\t\t\t\t\"{$name}\": \"{$property}\",\n";
}
print "\t\t\t},\n";
            endforeach; ?>
            "language": {
